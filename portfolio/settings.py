...
# Serve static files directly from the source 'static/' folder (via finders)
# instead of a hashed manifest. This guarantees the newest CSS/JS is always
# served, avoiding stale cached designs after edits/deploys.
